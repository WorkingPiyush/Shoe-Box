  ...
  return (
    <div className='w-full bg-white/60 p-5 flex justify-center fixed top-0 z-50 backdrop-blur-lg'>
      <div className='w-full flex justify-around items-center max-md:px-0 max-md:justify-between relative'>
        ...
        <div className='flex gap-4 font-bold justify-center items-center relative'>
          <FaShoppingCart className='cursor-pointer' />
          <img onMouseEnter={MouseEnter} onMouseDown={MouseLeave} className='h-10 w-10 rounded-full cursor-pointer' src={profileImg} alt="useimage" />
          {isHovered && <UserCall />}
