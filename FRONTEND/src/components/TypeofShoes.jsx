...
const shoeImg = [
    { id: 1, src: shoe1, title: "Runnig Shoes", filter: "Running" },
    { id: 5, src: shoe5, title: "Sports Shoes", filter: "Sports" },
    { id: 3, src: shoe3, title: "Sneakers Shoes", filter: "Sneakers" },
    { id: 2, src: shoe2, title: "Gym Shoes", filter: "Gym" },
    { id: 6, src: shoe6, title: "Walking Shoes", filter: "Casual shoes" },
    { id: 4, src: shoe4, title: "Training Shoes", filter: "Running" },
]
